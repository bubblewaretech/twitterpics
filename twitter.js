JQTWEET = {
    ...
    hash: '%23puppy', //leave this blank if you want to show user's tweet
    user: '',
    numTweets: 100,
    //If pages dont exist, We'll throw error in console
    numPages: 25,
    ...
    loadTweets: function (pagenumber) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, xhr) {
                ...
                if (data == null) {
                    console.log('we couldnt get any data back from the query on this page ' + pagenumber);
                    return;
                };
